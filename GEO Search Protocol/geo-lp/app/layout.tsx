  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-RTVYFRXR2M"></script>
        <script
        ...
        {/* Google Ads */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-BS30YQY1N7"></script>
        <script
          dangerouslySetInnerHTML={{
            __html: `
              window.dataLayer = window.dataLayer || [];
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              ...
              })(window, document, "clarity", "script", "w0amzirytq");
            `,
          }}
        />
